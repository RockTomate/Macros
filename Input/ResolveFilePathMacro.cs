...
{
    [Macro(FieldType.Input, "filepath")]
    public class ResolveFilePathMacro : BaseMacro<string[]>
    {
        /// <inheritdoc />
        ...
        protected override string[] OnInvoke(JobContext context, params object[] args)
        {
            ...
            return PathHelpers.ResolvePaths(path, false, searchOption, convertToRelative);
        }
    }
}